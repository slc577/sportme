...
{
	var adjs = ['an aloof ', 'a lonely ', 'your average ']
...
function get_throw(name, sport, sporter)
{
	...
	var struggles = [ '. Despite these turn of events, the ' + sport + ' team will soon have to face the rival high school in the season championships.',
...
function get_motivation(name, sport, sporter)
{
	...
	var actions = [ name + ' and the rest of the ' + sporters + ' must learn what it means to be a team',
...
module.exports = 
{
	get_story: function(sport, sporter)
	{
		...
		return intro + throws + motivation
	}
}
